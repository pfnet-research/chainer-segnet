...
from models import softmax_cross_entropy
...
class TestSoftmaxCrossEntropy(unittest.TestCase):
    ...
    def check_backward(self, x_data, t_data, class_weight, use_cudnn=True):
        func = softmax_cross_entropy.SoftmaxCrossEntropy(
...
class TestSoftmaxCrossEntropyValueCheck(unittest.TestCase):
    ...
    def check_value_check(self, x_data, t_data, use_cudnn):
        ...
        if self.valid:
            ...
            softmax_cross_entropy.softmax_cross_entropy(x, t, use_cudnn)
        else:
...
class TestSoftmaxCrossEntropyCudnnCall(unittest.TestCase):
    ...
    def forward(self):
        ...
        return softmax_cross_entropy.softmax_cross_entropy(x, t, self.use_cudnn)
