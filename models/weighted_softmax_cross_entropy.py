...
class WeightedSoftmaxCrossEntropy(SoftmaxCrossEntropy):
...
def weighted_softmax_cross_entropy(
        x, t, channel_weights, use_cudnn=True, normalize=True,
        cache_score=True):
    ...
    Args:
        ...
        channel_wights (numpy.ndarray): An array that contains coefficients
            that will be multiplied to loss values along with channel
            dimension.
    ...
    """
    return WeightedSoftmaxCrossEntropy(use_cudnn, normalize, cache_score)(
        x, t, channel_weights)
